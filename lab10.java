    ...
    public static void Q1() {
        while (true) {
            ...
            if (input.equals("square")) {
                ...
                double a = Double.parseDouble(scan.nextLine());     //the variable a can be defined in one line
                System.out.println("The circumference of the square is: " + a * 4);
                System.out.println("The area of the square is: " + a * a);

            } else if (input.equals("rectangle")) {
                System.out.println("Enter the length of side a and b: ");   //Both sides can be prompted from the same statement
                double a = Double.parseDouble(scan.nextLine());     //the variable a can be defined in one line
                double b = Double.parseDouble(scan.nextLine());     //the variable b can be defined in one line
                System.out.println("The circumference of the rectangle is: " + (2 * a + 2 * b));
                System.out.println("The area of the rectangle is: " + (a * b));
            } else if (input.equals("circle")) {
                System.out.println("Enter the radius: ");
                double r = Double.parseDouble(scan.nextLine());     //the variable rcircle can be defined in one line
